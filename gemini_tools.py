...
TOOL_SCHEMAS = [
    ...
    },
    {
        "name": "verify_answer",
        "description": (
            "Verify whether a specific factual statement is supported by the knowledge base. "
    ...
    },
    {
        ...
        "description": (
            "Propose a custom markdown structure for the final answer. "
            "Use this AFTER gathering enough evidence but BEFORE writing the Final Answer. "
            "It helps organize complex information into logical sections (e.g., headings, tables, bullets) "
            "specifically tailored to the user's request."
        ),
        "parameters": {
            "type": "OBJECT",
            "properties": {
    ...
    def _plan_answer_structure(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "instruction": (
                ...
                "Proceed to write your Final Answer using the planned sections. Ensure 100% accuracy."
            )
        }
